      ...
      <div class="row border-bottom-black">
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            <img class="mb-20" alt="" src="{{asset('assets/frontend/images/logo-wide-white.png')}}">
            ...
            <form id="mailchimp-subscription-form-footer" class="newsletter-form">
              <div class="input-group">
                ...
                <span class="input-group-btn">
                  <button data-height="45px" class="btn btn-colored btn-theme-colored btn-xs m-0 font-14" style="height: 45px" type="submit">Subscribe</button>
                </span>
              </div>
            </form>
